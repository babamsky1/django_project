...
from .views.employees import employees_list, employees_create, employees_edit, employees_delete
from .views.customers import customers_list, customers_create, customers_edit, customers_delete
from .views.products import products_list, products_create, products_edit, products_delete
from .views.suppliers import suppliers_list, suppliers_create, suppliers_edit, suppliers_delete
from .views.categories import categories_list, categories_create, categories_edit, categories_delete
from .views.shippers import shippers_list, shippers_create, shippers_edit, shippers_delete
from .views.orders import orders_list, orders_create, orders_edit, orders_delete
from .views.order_details import order_details_list, order_details_create, order_details_edit, order_details_delete
